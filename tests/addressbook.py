...
with open("addressbook_capnproto.bin", "w+b") as f:
...
with open("addressbook_capnproto.bin", "rb") as f:
...
with open("addressbook_flatbuffers.bin", "w+b") as f:
...
with open("addressbook_flatbuffers.bin", "rb") as f:
...
with open("addressbook_protobuf.bin", "w+b") as f:
    hb.write(f, "Person", dict(id=1, name="Roland", email="test@example.com"))
    hb.write(f, "Person", dict(id=2, name="Reinhard", email="test@example.com"))
    hb.write(f, "Person", dict(id=3, name="Rydberg", email="test@example.com"))
with open("addressbook_protobuf.bin", "rb") as f:
